================================================================================
MICROSOFT 基础类库: WinUI 项目概述
===============================================================================

应用程序向导已为您创建了这个 WinUI 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。
...
res\WinUI.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 WinUI.rc 中。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 WinUI.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
